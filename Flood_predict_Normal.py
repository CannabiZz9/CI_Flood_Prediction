...
parameters, final_loss, final_percent_loss = train_mlp(X_train, Y_train, hidden_layers, epochs, learning_rate)
...
plt.legend()
plt.title(f'Training Data - Final Loss: {final_loss:.4f}, Percent Loss: {final_percent_loss:.2f}%')
plt.show()
...
plt.legend()
plt.title(f'Testing Data - Final Loss: {final_loss:.4f}, Percent Loss: {final_percent_loss:.2f}%')
plt.show()